...
const PortfolioCard = ({ portfolio }) => {
  return (
    <div className="relative">
      {/* aplica un blur por debajo de la card */}
      ...
      <div className="relative rounded-xl  bg-white ">
        ...
        <div className="p-2">
          <div className=" flex flex-row">
            <div className="rounded-lg border border-lime-500 px-2 py-1 text-center text-xs font-bold uppercase text-black">
              {portfolio.categoria}
            </div>
          </div>
          ...
          <div className="mt-8 mb-4 flex justify-around ">
            ...
            {portfolio.categoria === 'MOTION GRAPHICS' ? (
              ...
              <div className="flex items-center">
                ...
                <button className="focus:shadow-outline h-8 rounded-lg border border-lime-500 px-2 font-bold text-lime-700 transition-colors duration-150 hover:bg-lime-500 hover:text-indigo-100 md:text-xs">
                  <a
