...
const Contact = () => {
  return (
    <div className="mt-10 flex w-full items-center justify-center">
      <div className="flex w-full max-w-7xl  flex-col space-y-6 rounded-xl bg-cyan-700 p-8 text-white shadow-lg md:flex-row md:space-x-6 md:space-y-0  ">
        <div className="flex flex-col justify-between space-y-10">
          ...
          <div className="space-x-10">
            ...
            <a href="#">
              <Image width="27" height="27" src={youtube} alt="facebook icon" />
            </a>
            <a href="#">
              <Image
                width="27"
        ...
        <div className="-8 rounded-xl bg-white p-4 shadow-lg md:w-2/3">
          <form className="flex flex-col space-y-4" action="">
            ...
            <button className="inline-block self-end rounded-lg bg-cyan-700 px-6 py-2 text-sm font-bold uppercase text-white ">
              Enviar
            </button>
          </form>
        </div>
